...
rm -rf ./notebooks/sample-notebooks/tensorflow-sample-notebooks
cp -rf ./tensorflow/tensorflow/tools/docker/notebooks ./notebooks/sample-notebooks/tensorflow-sample-notebooks
